...
<body class="bodymainbg">
	...
	<!-- Updates: changes lang sa mga <H2> <H3> and images. 2 products lang meron and isang size lang both -->
			...
			<ul>
				<li>
					...
					<div class="card2">
						<img class="c2img" src="../imgs/combo1.jpg" alt="">
						<div class="card-content">
							<h2> COMBO 1</h2>
							<h3> Hawaiian, Margherita, Pepperoni, Cheesy Bacon and Ham, Veggie Overload </h3>				<!-- Price: 699 pesos size "18  -->
							<br>
				...
				<li>
					...
					<div class="card2">
						<img class="c2img" src="../imgs/combo2.jpg" alt="">
						<div class="card-content">
							<h2> COMBO 2 </h2>
							<h3> Beef 'n Mushroom, Garlic 'n Shrimp, All meat, Tori Teriyaki, Creamy Pepperoni </h3>				<!-- Price: 699 pesos size "18-->
							<br>
