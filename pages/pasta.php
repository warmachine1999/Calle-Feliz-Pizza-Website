...
<body class="bodymainbg">
	...
	<!-- Updates: changes lang sa mga <H2> <H3>. 3 products lang nandito.  -->
			...
			<ul>
				<li>
					...
					<div class="card2">
						<img class="c2img" src="../imgs/pasta1.jpg" alt="">
						<div class="card-content">
							<h2> SHRIMP PESTO ala carte</h2>
							<h3> White pesto sauce, mozzarella, Shrimp, Basil, Quickmelt, Butter and seasoning </h3>				<!-- Price: 129 pesos  -->
							<br>
				...
				<li>
					...
					<div class="card2">
						<img class="c2img" src="../imgs/pasta2.jpg" alt="">
						<div class="card-content">
							<h2> CREAMY SPAGHETTI ala carte</h2>
							<h3>  Tomato paste, mozzarella, quickmelt, butter, cream, ground beef and seasoning </h3>			<!-- Price: 99 pesos  -->
							<br>
				...
				<li>
					...
					<div class="card2">
						<img class="c2img" src="../imgs/pasta3.jpg" alt="">
						<div class="card-content">
							<h2> TUNA RED SAUCE ala carte </h2>
							<h3> Tomato sauce, tomato paste, mozzarella, quickmelt, olive, basil, gound beef, herbs and seasoning </h3>				<!-- Price: 89 pesos  -->
							<br>
